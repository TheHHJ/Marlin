...
// @section lcd
  ...
  #define SHORT_MANUAL_Z_MOVE 0.1 // (mm) Smallest manual Z move (< 0.1mm)
...
//
  ...
  //#define GRAPHICAL_TFT_ROTATE_180                            Tjek rotation TheHHJ
 ...
 */
   ...
   * and make loading more reliable. Suitable for an extruder eq+uipped with a filament
